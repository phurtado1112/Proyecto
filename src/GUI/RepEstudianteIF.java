 ...
 * @author PabloAntonio
 */
public class RepEstudianteIF extends javax.swing.JInternalFrame {
...
public void reporteEstudianteDetalle() {       
        try {
            ...
            File f1 = new File("src/reportes/repEstudianteDetalle.jasper");            
    ...
    public void reporteEstudiante() {       
        try {
            ...
            File f1 = new File("src/reportes/repEstudiante.jasper");            
            String template = f1.getPath();
            reporte = (JasperReport) JRLoader. loadObject(template); 
    ...
    private void initComponents() {
        ...
        setTitle("Reporte de Catálogo Estudiante"); // NOI18N
